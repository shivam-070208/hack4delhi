...
const menuItems = [
  { name: "Dashboard", href: "/employee/dashboard", icon: UserCircle },
  { name: "Attendance", href: "/employee/dashboard/attendance", icon: Users },
  { name: "Grievance", href: "/employee/dashboard/grievance", icon: Users },
];
