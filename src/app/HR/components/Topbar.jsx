...
export default function Topbar({ collapsed }) {
  return (
    <header
      className={`sticky top-0 z-10 flex h-20 items-center justify-between border-b border-slate-100 bg-white/80 px-8 backdrop-blur-md transition-all duration-300 ${
    ...
    >
      ...
      <div className="relative hidden w-96 items-center md:flex">
        ...
        <input
          ...
          className="w-full rounded-xl bg-slate-50 py-2 pr-4 pl-10 text-sm outline-none transition-all focus:ring-2 focus:ring-indigo-500"
        />
      </div>
      ...
      <div className="flex items-center gap-6">
        ...
        <div className="group flex cursor-pointer items-center gap-3">
          <div className="hidden text-right sm:block">
            ...
            <p className="mt-1 text-xs text-slate-500">HR Manager</p>
          </div>
