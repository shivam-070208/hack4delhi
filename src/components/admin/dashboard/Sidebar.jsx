...
export function SidebarProvider({ children }) {
  ...
  return (
    <SidebarContext.Provider
      value={{ open, closeSidebar, openSidebar, isMobile, setOpen }}
    >
      {children}
    </SidebarContext.Provider>
  );
...
export default function Sidebar() {
  ...
  const { open, closeSidebar, isMobile, setOpen } = useSidebar();
  ...
  return (
    <>
      ...
      >
        {/* Close Icon on mobile, no menu icon (default closed) */}
